  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <Skeleton className="w-28 h-28 rounded-full mb-6 bg-[#C3E41D]/20" />
        {/* Name skeleton */}
        <Skeleton className="h-12 w-72 rounded-md bg-[#C3E41D]/20 mb-3" />
        {/* Title skeleton */}
        <Skeleton className="h-6 w-56 rounded-md bg-[#C3E41D]/20 mb-6" />
        {/* CTA buttons skeleton */}
        <div className="flex gap-4">
          <Skeleton className="h-11 w-36 rounded-md bg-[#C3E41D]/20" />
          <Skeleton className="h-11 w-28 rounded-md bg-[#C3E41D]/20" />
        </div>
        {/* Scroll indicator skeleton */}
        <Skeleton className="mt-12 w-6 h-10 rounded-full bg-[#C3E41D]/20" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 space-y-16 pb-20">
        ...
        <div className="space-y-4">
          <Skeleton className="h-8 w-32 rounded-md bg-[#C3E41D]/20 mx-auto" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex flex-col items-center gap-2">
              <Skeleton className="h-10 w-16 rounded-md bg-[#C3E41D]/20" />
        ...
        <div className="space-y-4">
          <Skeleton className="h-8 w-36 rounded-md bg-[#C3E41D]/20 mx-auto" />
        ...
        <div className="space-y-4">
          <Skeleton className="h-8 w-40 rounded-md bg-[#C3E41D]/20 mx-auto" />
          <div className="space-y-8 max-w-2xl mx-auto">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex gap-4">
                <div className="flex flex-col items-center">
                  <Skeleton className="h-4 w-4 rounded-full bg-[#C3E41D]/20 shrink-0" />
        ...
        <div className="space-y-4">
          <Skeleton className="h-8 w-28 rounded-md bg-[#C3E41D]/20 mx-auto" />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="space-y-3">
              ...
              <Skeleton className="h-10 w-full rounded-md bg-[#C3E41D]/20" />
            </div>
            <div className="space-y-3">
              <Skeleton className="h-4 w-full rounded-md bg-muted" />
