...
const ProfileImage: React.FC<{ isDark: boolean }> = ({ isDark }) => {
  ...
  const size = "w-[80px] h-[180px] sm:w-[110px] sm:h-[110px] md:w-[130px] md:h-[130px] lg:w-[150px] lg:h-[250px]";

  return (
    <div
      className="absolute top-1/2.5 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10"
      style={{
        opacity,
