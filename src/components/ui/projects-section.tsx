      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {projects.map((project, index) => (
            ...
            >
              <Card className="dark:bg-[hsl(0,0%,12%)] bg-white dark:border-neutral-800 border-neutral-200 dark:hover:border-[#C3E41D]/40 hover:border-[#C3E41D]/60 transition-all duration-300 overflow-hidden group h-full relative">
                {project.featured && (
